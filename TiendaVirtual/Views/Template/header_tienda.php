...
$tituloPreguntas = !empty(getInfoPage(PPREGUNTAS)) ? getInfoPage(PPREGUNTAS)['Pag_Titulo'] : "";
$infoPreguntas = !empty(getInfoPage(PPREGUNTAS)) ? getInfoPage(PPREGUNTAS)['Pag_Contenido'] : "";
?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	if(!empty($data['producto'])){
		...
		$descripcion = DESCRIPCION;
		$nombreProducto = $data['producto']['Prod_Nombre'];
		$urlWeb = base_url()."/tienda/producto/".$data['producto']['IdProducto']."/".$data['producto']['Prod_Ruta'];
			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					...
					<?= MENSAJE ?>
						...
						'])){ ?>
							Bienvenido: <?= $_SESSION['userData']['Per_Nombres'].' '.$_SESSION['userData']['Per_Apellidos'] ?>
						<?php } ?>
					</div>
