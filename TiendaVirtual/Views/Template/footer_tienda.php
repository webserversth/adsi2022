		...
		<div class="container">
			<div class="row">
				<div class="col-sm-6 col-lg-4 p-b-50">
					...
					<ul>
						...
						<li class="p-b-10">
							<a href="<?= base_url() ?>/tienda/categoria/<?= $cat['IdCategoria'].'/'.$cat['Cat_Ruta'] ?>" class="stext-107 cl7 hov-cl1 trans-04">
								<?= $cat['Cat_Nombre'] ?>
							</a>
						</li>
						<?php } ?>
			...
			<div class="p-t-40">
				<p class="stext-107 cl6 txt-center">
					<?= NOMBRE_EMPESA; ?> | <?= WEB_EMPRESA; ?> | <a href="http://www.cdtisena.com/" target="_blank">Cdtisena</a>
				</p>
			</div>
		</div>
	</footer>
