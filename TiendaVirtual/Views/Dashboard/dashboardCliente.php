            ...
            <table class="table table-striped table-sm">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?= $pedido['Ped_Nombre'] ?></td>
				  <td><?= $pedido['Est_IdEstado'] ?></td>
            ...
            <div class="container-title">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?= SMONEY. formatMoney($producto['Prod_Precio']) ?></td>
                  <td><a href="<?= base_url() ?>/tienda/producto/<?= $producto['IdProducto'].'/'.$producto['Prod_Ruta'] ?>" target="_blank"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
                </tr>
                <?php } 
                  } ?>
