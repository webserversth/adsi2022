            ...
            <div class="col-md-12">
              <div class="tile">
                <form id="formPaginas" name="formPaginas" class="form-horizontal">
                  <input type="hidden" id="idPost" name="idPost" value="<?= $data['infoPage']['IdPagina'] ?>">
                  ...
                  <div class="row">
                    <div class="col-md-10">
                        <div class="form-group">
                          ...
                          <input class="form-control" id="txtTitulo" name="txtTitulo" type="text" value="<?= $data['infoPage']['Pag_Titulo'] ?>" required="">
                        </div>
                        <div class="form-group">
                          <label class="control-label">Contenido</label>
                          <textarea class="form-control" id="txtContenido" name="txtContenido" >
                            <?= $data['infoPage']['Pag_Contenido'] ?>
                          </textarea>
                        </div>
