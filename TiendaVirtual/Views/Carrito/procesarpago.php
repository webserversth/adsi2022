...
$tituloTerminos = !empty(getInfoPage(PTERMINOS)) ? getInfoPage(PTERMINOS)['Pag_Titulo'] : "";
$infoTerminos = !empty(getInfoPage(PTERMINOS)) ? getInfoPage(PTERMINOS)['Pag_Contenido'] : "";
					...
					?>
						<div>
							...
							<div class="bor8 bg0 m-b-22">
								<input id="txtCiudad" class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="postcode" placeholder="Departamento / Ciudad">
							</div>
						</div>
					<?php }else{ ?>
								...
								<div id="divtipopago" class="notblock" >
									...
									<div class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9">
										...
										<?php 
										 ...
										 ?>
										 	<option value="<?= $tipopago['IdTipopago']?>"><?= $tipopago['Tpag_Tipopago']?></option>
										<?php
													}
												}
										 } ?>
