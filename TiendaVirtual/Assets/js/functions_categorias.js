...
function fntViewInfo(idcategoria){
    ...
    request.onreadystatechange = function(){
        if(request.readyState == 4 && request.status == 200){
            ...
            if(objData.status)
            {
                let estado = objData.data.Est_IdEstado == 1 ? 
                '<span class="badge badge-success">Activo</span>' : 
                '<span class="badge badge-danger">Inactivo</span>';
                document.querySelector("#celId").innerHTML = objData.data.IdCategoria;
                document.querySelector("#celNombre").innerHTML = objData.data.Cat_Nombre;
                document.querySelector("#celDescripcion").innerHTML = objData.data.Cat_Descripcion;
    ...
    request.onreadystatechange = function(){
        if(request.readyState == 4 && request.status == 200){
            ...
            if(objData.status)
            {
                ...
                document.querySelector("#txtNombre").value = objData.data.Cat_Nombre;
                document.querySelector("#txtDescripcion").value = objData.data.Cat_Descripcion;
                document.querySelector('#foto_actual').value = objData.data.Cat_Portada;
                ...
                if(objData.data.Cat_Portada == 'portada_categoria.png'){
                    document.querySelector('.delPhoto').classList.add("notBlock");
                }else{
                    document.querySelector('.delPhoto').classList.remove("notBlock");
                }
