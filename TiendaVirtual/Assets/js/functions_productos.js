    ...
    request.onreadystatechange = function(){
        if(request.readyState == 4 && request.status == 200){
            ...
            if(objData.status)
            {
                ...
                let estadoProducto = objProducto.Est_IdEstado == 1 ? 
                '<span class="badge badge-success">Activo</span>' : 
                '<span class="badge badge-danger">Inactivo</span>';

                document.querySelector("#celCodigo").innerHTML = objProducto.Prod_Codigo;
                document.querySelector("#celNombre").innerHTML = objProducto.Prod_Nombre;
                ...
                document.querySelector("#celDescripcion").innerHTML = objProducto.Prod_Descripcion;
    ...
    request.onreadystatechange = function(){
        if(request.readyState == 4 && request.status == 200){
            ...
            if(objData.status)
            {
                ...
                document.querySelector("#txtNombre").value = objProducto.Prod_Nombre;
                document.querySelector("#txtDescripcion").value = objProducto.Prod_Descripcion;
                document.querySelector("#txtCodigo").value = objProducto.Prod_Codigo;
                ...
                document.querySelector("#listCategoria").value = objProducto.Cat_IdCategoria;
                document.querySelector("#listStatus").value = objProducto.Est_IdEstado;
                tinymce.activeEditor.setContent(objProducto.Prod_Descripcion); 
